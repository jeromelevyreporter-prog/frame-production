    ...
    about: {
      ...
      founder: {
        ...
        bio: [
          ...
          "Diplômé en journalisme (École de Journalisme et Communication de Marseille), en droit des médias (Aix-Marseille III) et en droit international (Sheffield), il forme par ailleurs des journalistes dans différentes écoles (ESJ Pro Montpellier, EJCAM), et des personnalités publiques à la gestion de crise.",
        ],
        placeholderNote: "",
      },
    },
    ...
    about: {
      ...
      founder: {
        ...
        bio: [
          ...
          "Holding a Master's in Journalism (School of Journalism and Communication of Marseille), Media Law (Aix-Marseille III) and International Law (Sheffield), he also trains journalists at various schools (ESJ Pro Montpellier, EJCAM), and public figures in crisis management.",
        ],
        placeholderNote: "",
      },
    },
